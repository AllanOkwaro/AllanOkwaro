...
- **Honeybees** (*Apis mellifera*) – Social complexity, division of labor, caste differentiation, and age-dependent changes
- **Termites** (*Isoptera*) – Eusocial organization, reproductive castes, and long-lived queens
- **Mosquitoes** (*diptera*) - Brackishwater and saline water adapted _Aedes aegypti_
...
- Whole-Genome Sequencing (WGS) – Variant calling, mutation analysis, and population genetics
- RNA-Seq – Gene expression analysis, differential expression, and transcriptomics
- ChIP-Seq – Chromatin immunoprecipitation analysis and epigenetic profiling
...
Here are some of my key research projects and contributions:
...
I'm committed to open science principles. All my research code, pipelines, and data are made publicly available whenever possible (and where not restricted by data-sharing agreements). I believe in transparent methods, reproducible analyses, and collaborative science.
